...
ADDONS=( \
"FreeplayGBAcm3-Actualizacion_del_sistema off" \
"FreeplayGBAcm3-Emulators.cfg on" \
"FreeplayGBAcm3-Configuraciones_de_juegos on" \
"temperatureMonitor off" \
)
...
do
	...
	if git clone https://github.com/julenvitoria/"$ADDON" ; then
